    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="control-group">
            ...
            <?php foreach($form_main as $form): ?>
                <option value="<?= $form['form_main_id'] ?>"><?= strtoupper(str_replace('_', ' ', $form['form_name']))  ?></option>
            <?php endforeach ?>
            </select>
        ...
        <div class="control-group">
            ...
            <?php
             $data = array(
                ...
                'autofocus' => 'true',
                'class' => 'form-control',
                'value' => set_value('contract', '', FALSE)
            );
            $option = array('1'=>'FG- Impact','2'=>'DEV & PRD','3'=>'FG-Postproduction');
            echo form_dropdown('contract',$option,'',$data);
		...
		<div class="control-group">
            ...
            echo form_dropdown('description_type',$option,'',$data);
