                    ...
                    <div class="panel panel-primary ui-state-default">
                        <div class="panel-body row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="field_maxlenght1"><?php echo 'Max Length'; ?></label>
                                    <input type="number" name="max_length1[]" id="max_length" class="form-control" value="<?php echo $field_val['max_length']?>" maxlength="255">
                                </div>
                                <div class="control-group">	
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="control-group">	
                                    ...
                                    <textarea type="text" name="field_label1[]" id="field_label1" class="form-control" ><?php echo $field_val['field_label']?></textarea>
                                </div>
                                <div class="control-group">	
            ...
            <div class="entry panel panel-default">
                <div class="panel-body row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="field_maxlenght"><?php echo 'Max Length'; ?></label>
                            <input type="number" name="max_length[]" id="max_length" class="form-control" maxlength="255">
                        </div>
                        <div class="control-group">	
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="control-group">	
                            ...
                            <textarea type="text" name="field_label[]" id="field_label" class="form-control" ></textarea>
                        </div>
                        <div class="control-group">	
