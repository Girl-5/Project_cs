...
<!--========== FOR DATATABLE CSS AND JS ====================================-->
    <link href="<?= base_url(); ?>assets/datatable/css/jquery.dataTables.min.css" rel="stylesheet">
    <link href="<?= base_url(); ?>assets/datatable/css/buttons.dataTables.min.css" rel="stylesheet">
    <link href="<?= base_url(); ?>assets/datatable/css/dataTables.tableTools.css" rel="stylesheet">

    <!-- jQuery -->
    <!--<script src="<?= base_url(); ?>assets/datatable/js/jquery.min.js"></script>-->
    <script src="<?= base_url(); ?>assets/datatable/js/jquery.dataTables.min.js"></script>
    <script src="<?= base_url(); ?>assets/datatable/js/jquery.dataTables.bootstrap.min.js"></script>
    
    <script src="<?= base_url(); ?>assets/datatable/js/dataTables.buttons.min.js"></script>  
    <script src="<?= base_url(); ?>assets/datatable/js/buttons.flash.min.js"></script>
    
    <script src="<?= base_url(); ?>assets/datatable/js/jszip.min.js"></script>
    <script src="<?= base_url(); ?>assets/datatable/js/pdfmake.min.js"></script>
    <script src="<?= base_url(); ?>assets/datatable/js/vfs_fonts.js"></script>
    <script src="<?= base_url(); ?>assets/datatable/js/buttons.html5.min.js"></script>
    <!-- <script src="js/buttons.print.min.js"></script> -->
<script>
      $(document).ready(function() {
          
        //============== FOR APPLICANT DATA TABLE =============
        ...
        // ==== FOR APPLICATION DATA TABLES  =============
        $('#dynamic_table_1').DataTable({
          
        });
        
        //============== FOR VIEW ONE APPLICATIONS DATA TABLE =============
        $('#dynamic_table_3').DataTable({
         ...
         paging: false,
          ...
          buttons: {
            ...
            // {
            //     extend: 'excelHtml5',
            //     title: 'Total Applicaitons and Applicants',
            //     // exportOptions: {
            //     //     columns: [ 0,2,3,4,5,6,7 ]
            //     // },
            // },
        ...
        //============== FOR DASHBORAD DATA TABLE =============
        $('#all_details_datatable').DataTable({
          "ordering": false,
          dom: 'lBfrtip',
          buttons: {
            buttons: [
            {
                ...
                customize: function(doc) {
                 doc.defaultStyle.alignment = 'left';
                 doc.content[1].table.widths = [ '40%', '40%'];
                },  
                title : function() {
                    return "Total Applicaitons and Applicants";
                },
               //orientation : 'landscape',
                pageSize : 'A4'
            },
        ...
        $('#countrywise_datatable').DataTable({
          "ordering": false,
          dom: 'lBfrtip',
          buttons: {
            buttons: [
            ...
            {
                extend: 'excelHtml5',
                title: 'Country wise Details',
            },],
          }
        });
        
        $('#applicationwise_datatable').DataTable({
          "ordering": false,
          dom: 'lBfrtip',
          buttons: {
            buttons: [
        ...
        $('#applicant_infod_datatable').DataTable({
          "ordering": false,
          dom: 'lBfrtip',
          buttons: {
            buttons: [
        ...
        //==============END DASHBOARD HERE  FOR DASHBORAD DATA TABLE =============
        
     });
     
    
function hideShow(check_val) {
        
    console.log("value ==="+check_val)
    if(check_val == '1'){
        $(".all_details").show();
        $(".country_info").hide();
        $(".application_infod").hide();
        $(".applicant_infod").hide();
        
    }
    if(check_val == '2'){
        $(".application_infod").show();
        $(".all_details").hide();
        $(".country_info").hide();
        $(".applicant_infod").hide();
    }
    if(check_val == '3'){
        $(".applicant_infod").show();
        $(".application_infod").hide();
        $(".all_details").hide();
        $(".country_info").hide();
    }
...
<script>
    function checkvalidation(){
        ...
        var textareavalu = $('#twelth_ques').val().trim();
        if (($('input[name=ten_ques_a]:checked').length > 0) && ($('input[name=eleven_ques_a]:checked').length > 0) && (textareavalu != "")) {
           //alert("all okay now");
            //return false;
        }else{
            // alert("All Question's answer are required!");
            // return false;
        }
    }
</script>
