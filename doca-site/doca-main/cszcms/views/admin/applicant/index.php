...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <!--<div class="h2 sub-header"><?php echo  $this->lang->line('applicant_all') ?> <a style="display:none;" role="button" href="<?php echo $this->Csz_model->base_link()?>/admin/applicant/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('applicant_addnew') ?></a>-->
        <!--</div>-->
        <!--<form action="<?php// echo $this->Csz_model->base_link(). '/admin/applicant/'; ?>" method="get">-->
