        ...
        <div class="wrapper"> <!-- full width wrapper -->
            <div class="formBox">
                <div class="formWrapper">
                    <?php echo form_open_multipart(base_url(). 'save_project_description/'.$this->uri->segment(2).'/'.$form['form_main_id'].'/'.$application['id']); ?>
                    ...
                    <div class="formRow">
                        ...
                        if($field['field_type'] == 'selectbox'){
                            ...
                            if(!is_null($field['form_field_value'])){ ?>
                                   ...
                                   <small> <a target="_blank" href="<?php echo base_url('photo/image/'.$field['form_field_value']); ?>" > <i style="" class="fa fa-file" aria-hidden="true"></i> Current File </a></small>
