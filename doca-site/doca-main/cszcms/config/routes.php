...
$route['admin/getreviews'] = "admin/admin/getreviews";
$route['admin/getreviewcomments/:num'] = "admin/admin/getreviewcomments";
$route['admin/getreviewcomments/:num/:num'] = "admin/admin/getreviewcomments";
...
//grant
$route['admin/grant'] = 'admin/grant/index';
$route['admin/grant/new'] = "admin/grant/addgrant";
$route['admin/grant/new/add'] = "admin/grant/confirm";
$route['admin/grant/edit/:num'] = "admin/grant/editgrant";
$route['admin/grant/edited/:num'] = "admin/grant/edited";
$route['admin/grant/delete/:num'] = "admin/grant/delete";

//applicant
$route['admin/applicant/:num'] = 'admin/applicant/index';
$route['admin/applicant/:num'] = 'admin/applicant/index';
$route['admin/applicant/new'] = "admin/applicant/addapplicant";
$route['admin/applicant/new/add'] = "admin/applicant/confirm";
$route['admin/applicant/edit/:num'] = "admin/applicant/editapplicant";
$route['admin/applicant/edited/:num'] = "admin/applicant/edited";
$route['admin/applicant/delete/:num'] = "admin/applicant/delete";


//Application
$route['admin/application/:num'] = 'admin/application/index';
...
$route['eligibility_test'] = 'home/eligibility_test';
$route['login'] = 'home/login';
$route['saveRegister'] = 'home/saveRegister';
$route['loginCheck'] = 'home/loginCheck';
$route['logout'] = 'home/logout';
$route['contact_information'] = 'home/contact_information';
$route['saveContact'] = 'home/saveContact';
$route['profile'] = 'home/profile';
$route['savProfile'] = 'home/saveProfile';
$route['profile_info']  = 'home/profile_info';
$route['saveProfile_info']  = 'home/saveProfile_info';
// $route['profile_contract']  = 'home/profile_contract';
// $route['saveProfile_contract']  = 'home/saveProfile_contract';

//grant details
$route['details/:num'] = 'home/details';
$route['dashboard'] = 'dashboard/index';
$route['viewApplication/:num'] = "home/viewApplication";
$route['userView/:num'] = "home/userView";
...
//aplly  
$route['apply/:num']     =   'grant_apply/index';
$route['view/:num']     =   'grant_apply/view';
$route['saveProject/:num/:num/:num']  =   'grant_apply/saveProject';
$route['project_description/:num']     =   'grant_apply/project_description';
$route['save_project_description/:num/:num/:num']  =   'grant_apply/save_project_description';
$route['organisation/:num']     =   'grant_apply/organisation';
$route['save_organisation/:num']  =   'grant_apply/save_organisation';
$route['project_budget/:num']     =   'grant_apply/project_budget';
$route['save_project_budget/:num']  =   'grant_apply/save_project_budget';
$route['project_director/:num']     =   'grant_apply/project_director';
$route['save_director/:num']  =   'grant_apply/save_project_director';
$route['project_contract/:num']     =   'grant_apply/project_contract';
$route['save_project_contract/:num']  =   'grant_apply/save_project_contract';


//=== edit/update accepted application
$route['edit_accepted/:num']  =   'grant_apply/edit_accepted_application';
$route['edit_accepted/:num']  =   'grant_apply/edit_accepted_application';

$route['save_edited_application/:num']  =   'grant_apply/save_edited_application';
$route['save_edited_application/:num']  =   'grant_apply/save_edited_application';


$route['plugin/([a-zA-Z]+)/view/:num/:any/:num'] = "plugin/$1/view";
$route['plugin/([a-zA-Z]+)/view/:num/:any'] = "plugin/$1/view";
$route['plugin/([a-zA-Z]+)/grant/:any/:any/:num'] = "plugin/$1/grant";
$route['plugin/([a-zA-Z]+)/grant/:any/:any'] = "plugin/$1/grant";
$route['plugin/([a-zA-Z]+)/grant/:any/:num'] = "plugin/$1/grant";
$route['plugin/([a-zA-Z]+)/grant/:any'] = "plugin/$1/grant";
